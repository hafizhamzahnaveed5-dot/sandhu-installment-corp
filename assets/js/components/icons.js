/**
 * icons.js — Shared SVG icon set (feather-style line icons).
 * Keeps the whole app on one consistent icon language instead of emoji.
 *
 * Usage: Icon('customers')  or  Icon('check-circle', 40)
 */
...
const PATHS = {
  ...
  'book':         '<path d="M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M8 7h8"/><path d="M8 12h8"/><path d="M8 17h5"/>',
